 ...
 */
export const myIncludes = (array : string[], searchElement : string) => {
    let correct = 0
    array.forEach((e : string) => {
        if (e == searchElement) correct++
    })
 ...
 */
export const myIndexOf = (array : string[], searchElement : string) => {
 ...
 */
export const myStartsWith = (str : string, search : string) => {
    let splitStr = str.slice(0, search.length)
    if (splitStr === search) {
        return true
    } else {return false}
};
 ...
 */
export const myRepeat = (str : string, count : number) => {
    let newStr = "";
    if (count === 0) return newStr
 ...
 */
export const myJoin = (array : any[], separator: string) => {
    let newStr = "";
 ...
 */
export const myObjectKeys = (obj : Object) => {
    let objArray : string[] = [];
 ...
 *      // returns [['a', 1], ['b', 2]]
 */
export const myObjectEntries = (obj : any) => {
    const objArray : [string, unknown][] = [];
    for (const key in obj) {
